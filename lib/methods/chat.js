...
export const userInSession = {
  ...
  run({ sessionId, userId }) {
    if (!Sessions.findOne(sessionId)) return {sessionExists: false, userContent: null};
    return {sessionExists: true, userContent: Sessions.findOne(sessionId)['users'][userId]};
  },
